	...
	<table <?php tabel(100,'%',1,'left');  ?> >
        ...
        <tr class="event2">	
			...
			<td align="left">
				...
				</form> <?php echo baca_database('','satuan',"select * From data_produk where id_produk='$idproduknya'"); ?>
			</td>
			...
			<td class="th_border cell" align="left" width="200">
						<table border="0">
							<tr>
								<td>
									<a href="<?php index(); ?>?p=keranjang&action=delete&proses=<?php echo $idp = $data["$id"]; ?>&id_produk=<?php echo $data["$id_produk"]; ?>&jumlah=<?php echo $data["$jumlah"]; ?>">
...
<table class="table">
	...
	<td>:</td>
	<td>
		<textarea required  class='form-control selectpicker' value="" name="alamat_pengiriman"><?php echo baca_database("","alamat","select * from data_pelanggan where id_pelanggan='$ids'");?>
		</textarea>
	</td>
	</tr>
	...
	<td>:</td>
	<td>
		<input required  class='form-control selectpicker' value="<?php echo baca_database("","no_telepon","select * from data_pelanggan where id_pelanggan='$ids'");?>"  name="no_telepon_penerima" type="number">
	</td>
	</tr>
	...
	<td>:</td>
	<td>
		<input  class='form-control selectpicker' value="<?php echo baca_database("","nama_pelanggan","select * from data_pelanggan where id_pelanggan='$ids'");?>" required name="nama_penerima" id="nama_penerima" >
	</td>
	</tr>
</table>
</div>
...
<?php } ?>
	...
	<td>:</td>
	<td>
		<select  class='form-control selectpicker' required name="pembayaran" id="pembayaran" required="required">
		    <option>--Pilih Pembayaran--</option>
		    <?php combo_database2('data_bank', 'id_bank', 'nama_bank'); ?>
	...
	{
		?>
			<button style="background:#ff4e00" class="btn btn-danger"><?php echo $tombolfinish;?> </button>
		<?php
	}
	?>
