...
{   
	...
	<?php
	action_cetak("data_komentar"); 
}
else
{
	include '../../../include/all_include.php';
	proses_action_cetak("data_komentar");
?>
	<link rel="stylesheet" type="text/css" href="../../../data/cssjs/cetak/style_new.css">
	<link rel="stylesheet" type="text/css" href="../../../data/cssjs/cetak/style_new2.css">
...
<table width="100%"  class="tblcms2">
    <tr>
        ...
        <th class="th_border cell">id&nbsp;komentar</th>
        <th class="th_border cell"  >id&nbsp;produk</th>
<th class="th_border cell"  >id&nbsp;pelanggan</th>
<th class="th_border cell"  >foto</th>
<th class="th_border cell"  >komentar</th>
    ...
    <?php
				...
				if (isset($_GET['isi']) && !empty($_GET['isi']))
				{
					...
					$querytabel="SELECT * FROM data_komentar where $Berdasarkan like '%$isi%'";
				}
				else if (isset($_GET['tanggal1']) && !empty($_GET['tanggal1']))
				{
					...
					$querytabel="SELECT * FROM data_komentar where ($Berdasarkan BETWEEN '$tanggal1' AND '$tanggal2')";
				
				}
				else
				{
					//SEMUA
					$querytabel="SELECT * FROM data_komentar";
				}
...
<td align="center"><a href='../../../upload/<?php echo $data['foto']; ?>'><img onerror="<?php echo $imageerror; ?>'" width='50' height='30' src='../../../upload/<?php echo $data['foto']; ?>'></a></td>
