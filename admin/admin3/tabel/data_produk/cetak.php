...
{   
	...
	<?php
	action_cetak("data_produk"); 
}
else
{
	include '../../../include/all_include.php';
	proses_action_cetak("data_produk");
?>
	<link rel="stylesheet" type="text/css" href="../../../data/cssjs/cetak/style_new.css">
	<link rel="stylesheet" type="text/css" href="../../../data/cssjs/cetak/style_new2.css">
...
<th class="th_border cell"  >merk</th>
...
<th class="th_border cell"  >satuan&nbsp;jual</th>
<th class="th_border cell"  >foto</th>
<th class="th_border cell"  >keterangan</th>
<th class="th_border cell"  >berat&nbsp;barang</th>
    ...
    <?php
				...
				if (isset($_GET['isi']) && !empty($_GET['isi']))
				{
					...
					$querytabel="SELECT * FROM data_produk where $Berdasarkan like '%$isi%'";
				}
				else if (isset($_GET['tanggal1']) && !empty($_GET['tanggal1']))
				{
					...
					$querytabel="SELECT * FROM data_produk where ($Berdasarkan BETWEEN '$tanggal1' AND '$tanggal2')";
				
				}
				else
				{
					//SEMUA
					$querytabel="SELECT * FROM data_produk";
				}
