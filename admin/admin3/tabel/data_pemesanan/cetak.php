...
<table width="100%"  class="tblcms2">
    <tr>
        ...
        <th class="th_border cell">id&nbsp;pemesanan</th>
        <th class="th_border cell"  >kode&nbsp;transaksi&nbsp;penjualan</th>
<th class="th_border cell"  >tanggal&nbsp;pemesanan</th>
<th class="th_border cell"  >total&nbsp;bayar</th>
<th class="th_border cell"  >nama&nbsp;bank</th>
<th class="th_border cell"  >rekening</th>
<th class="th_border cell"  >kurir</th>
<th class="th_border cell"  >tujuan</th>
<th class="th_border cell"  >biaya&nbsp;ongkir</th>
<th class="th_border cell"  >tanggal&nbsp;upload&nbsp;bukti&nbsp;pembayaran</th>
<th class="th_border cell"  >foto&nbsp;bukti&nbsp;pembayaran</th>
<th class="th_border cell"  >no&nbsp;telepon&nbsp;penerima</th>
<th class="th_border cell"  >alamat&nbsp;pengiriman</th>
...
<td align="center"><?php echo (rupiah($data['biaya_ongkir'])); ?></td>
<td align="center"><?php 
error_reporting(0);
echo (format_indo($data['tanggal_upload_bukti_pembayaran'])); ?></td>
<td align="center"><a href='../../../upload/<?php echo $data['foto_bukti_pembayaran']; ?>'><img onerror="<?php echo $imageerror; ?>'" width='50' height='30' src='../../../upload/<?php echo $data['foto_bukti_pembayaran']; ?>'></a></td>
