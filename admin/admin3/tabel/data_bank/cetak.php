...
{   
	...
	<?php
	action_cetak("data_bank"); 
}
else
{
	include '../../../include/all_include.php';
	proses_action_cetak("data_bank");
?>
	<link rel="stylesheet" type="text/css" href="../../../data/cssjs/cetak/style_new.css">
	<link rel="stylesheet" type="text/css" href="../../../data/cssjs/cetak/style_new2.css">
...
<table width="100%"  class="tblcms2">
    <tr>
        ...
        <th class="th_border cell">id&nbsp;bank</th>
        <th class="th_border cell"  >nama&nbsp;bank</th>
<th class="th_border cell"  >nama&nbsp;pemilik</th>
<th class="th_border cell"  >rekening</th>
<th class="th_border cell"  >foto&nbsp;logo&nbsp;bank</th>
    ...
    <?php
				...
				else if (isset($_GET['tanggal1']) && !empty($_GET['tanggal1']))
				{
					...
					$querytabel="SELECT * FROM data_bank where ($Berdasarkan BETWEEN '$tanggal1' AND '$tanggal2')";
...
<td align="center"><a href='../../../upload/<?php echo $data['foto_logo_bank']; ?>'><img onerror="<?php echo $imageerror; ?>'" width='50' height='30' src='../../../upload/<?php echo $data['foto_logo_bank']; ?>'></a></td>
