...
if (!isset($_GET['proses']))
{
	...
	die();
			...
			?>
			   <tr>
				<td class="clleft" width="25%">id&nbsp;ongkir</td>
				<td class="clleft" width="2%">:</td>
				<td class="clleft"><?php echo $data['id_ongkir']; ?></td>	
			   </tr>
			   
			   <tr>
				<td class="clleft" width="25%">kurir</td>
				<td class="clleft" width="2%">:</td>
				<td class="clleft"><?php echo $data['kurir']; ?></td>	
			   </tr>
<tr>
